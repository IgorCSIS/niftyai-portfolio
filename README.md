...
|---|---|---|---|
| **[MASTER Prompt Library](https://igorcsis.github.io/prompt-library/)** ([code](https://github.com/IgorCSIS/prompt-library)) | 427 career-grade prompts built on a 9-layer framework (Mission, Agent, Situation, Task, Examples, Rules, Think, Eval, Output). Templates, completed exercises, and a scheduled scraper that surfaces the best prompts from across the web. | Next.js, TypeScript, GitHub Pages | Live |
